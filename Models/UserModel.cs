...
namespace ApiDocBot.Models
{
    public class UserModel
    {
        ...
        public string user_ide { get; set; } = string.Empty;
        ...
        public UserModel(int user_serial, byte[]? user_photo, string user_ide, string user_firstName, string? user_middleName, string user_lastName, string? user_secondLastname, DateTime user_birthDate, string user_userName, string? user_email, byte[] user_password, ICollection<UserRoleModel> userRoles)
        {
