...
{
    public class DiagnosticMlFreeModel
    {
        [Key]
        ...
        public DiagnosticMlFreeModel() { }

        public DiagnosticMlFreeModel(int diagnosticMlFree_id, int diagnosticMlFree_patientProfileFreeId, string diagnosticMlFree_riskLevel, string diagnosticMlFree_recommendations, bool diagnosticMlFree_needUrgentPsychologist, DateTime diagnosticMlFree_createdAt)
        {
