...
//using Microsoft.AspNetCore.Http.Features;  // <-- importante
//using Microsoft.EntityFrameworkCore;
...
//// Configurar JWT
//var key = Encoding.ASCII.GetBytes("pSKD93kdFJls00dkfJ2kfjLSKdj38DKSlskfjd94sldkfj");
...
//{
//    c.SwaggerDoc("v1", new() { Title = "app-docbot", Version = "v1" });

//    //  Configurar esquema JWT para Swagger
...
//// Middleware CORS específico para archivos estáticos (PDF, imágenes)
